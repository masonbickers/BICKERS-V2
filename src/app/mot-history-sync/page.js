...
function StatCard({ label, value, tone = UI.brand }) {
  return (
    <div style={{ ...card, padding: "var(--space-3)", minHeight: 78 }}>
...
export default function MotHistorySyncPage() {
  ...
  return (
    <HeaderSidebarLayout>
      <div style={pageWrap}>
        <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "flex-start", flexWrap: "wrap", marginBottom: "var(--space-3)" }}>
          <div>
        ...
        <div style={{ ...card, padding: "var(--space-3)", marginBottom: "var(--space-3)" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: 10 }}>
            <div>
              ...
              <div style={{ marginTop: 5, fontSize: "var(--font-size-lg)", fontWeight: 900, color: UI.text }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(5, minmax(0, 1fr))", gap: 10, marginBottom: "var(--space-3)" }}>
        ...
        <div style={{ ...card, overflow: "hidden", marginBottom: "var(--space-3)" }}>
          <div style={{ padding: "var(--space-3)", borderBottom: UI.border, display: "flex", alignItems: "center", gap: "var(--space-2)" }}>
          ...
          {updatedVehicles.length ? (
            ...
            <div style={{ padding: 14, color: UI.muted, fontSize: "var(--font-size-sm)" }}>
