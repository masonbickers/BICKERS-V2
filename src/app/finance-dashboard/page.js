    ...
    <HeaderSidebarLayout>
      ...
      <div style={pageWrap}>
        <div style={headerBar}>
          ...
          <div className="finance-header-actions" style={{ display: "flex", gap: "var(--space-2)", flexWrap: "wrap", justifyContent: "flex-end" }}>
            <div style={chip}>
          ...
          {financeLinks.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ marginTop: "var(--space-3)", display: "inline-flex", alignItems: "center", gap: 6, color: UI.brand, fontWeight: 800, fontSize: 12.5 }}>
                  Open
                  <ArrowRight size={14} />
                </div>
              </div>
