...
const styles = {
  ...
  section: {
    ...
    marginBottom: 22,
    padding: "18px",
    border: "1px solid var(--legacy-color-262f3d)",
    borderRadius: "12px",
    backgroundColor: "var(--legacy-color-101720)",
  },
  sectionTitle: {
    fontSize: "18px",
    fontWeight: "bold",
  ...
  input: {
    ...
    borderRadius: "6px",
    fontSize: "15px",
    backgroundColor: "var(--legacy-color-111827)",
    color: "var(--legacy-color-fff)",
  },
  primaryButton: {
    width: "100%",
  ...
  error: {
    color: "var(--legacy-color-f87171)",
    marginTop: "15px",
    fontSize: "14px",
  },
  success: {
    color: "var(--legacy-color-86efac)",
    marginTop: "12px",
    fontSize: "14px",
  },
};
