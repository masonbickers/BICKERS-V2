        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Column 2: Dates + Crew */}
              <div style={formColumnStyle}>
                <h3 style={{ ...labelHeadingStyle, fontSize: "13px", color: "var(--color-text)" }}>Dates</h3>
                ...
                <h3 style={{ ...labelHeadingStyle, fontSize: "13px", color: "var(--color-text)", marginTop: "10px" }}>Crew</h3>
                <div
                  className={layoutStyles.extracted8}
                >
                  {UCRANE_ROLES.map(({ role, key }) => (
                    <div key={role} className={layoutStyles.extracted9}>
                      <h4 className={layoutStyles.extracted10}>{role}</h4>
                ...
                <div className={layoutStyles.extracted13}>
                  <h4 className={layoutStyles.extracted14}>
              ...
              {/* Column 3: Vehicles */}
              <div style={formColumnStyle}>
                <h3 style={{ ...labelHeadingStyle, fontSize: "13px", color: "var(--color-text)" }}>Vehicles</h3>
                {["U-Crane", "Transport Lorry"].map((group) => {
                  const groupLabel = group === "Transport Lorry" ? "HGV" : group;
                  return (
                  <div key={group} className={layoutStyles.extracted15}>
                    <h4 className={layoutStyles.extracted16}>{groupLabel}</h4>
                    {vehicleGroups[group]?.length > 0 ? (
                      ...
                      <p className={layoutStyles.extracted18}>
            ...
            >
              <h3 style={{ ...labelHeadingStyle, fontSize: "13px", color: "var(--color-text)" }}>Notes</h3>
              <textarea
                value={notes}
            ...
            <div className={layoutStyles.extracted21}>
              <button type="submit" className={layoutStyles.extracted22}>
          ...
          >
            <h2 className={layoutStyles.extracted25}>
              Booking Summary
            </h2>
