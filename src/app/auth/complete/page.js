...
const styles = {
  page: { minHeight: "100vh", display: "grid", placeItems: "center", alignContent: "center", gap: 14, background: "#0d0d0d", color: "#fff", fontFamily: "Arial, sans-serif" },
  spinner: { width: 34, height: 34, border: "3px solid #374151", borderTopColor: "#ef4444", borderRadius: "50%", animation: "spin 0.8s linear infinite" },
};
