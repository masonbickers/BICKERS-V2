...
const styles = {
  ...
  kicker: { fontSize: 12, color: "var(--legacy-color-64748b)", fontWeight: 800, textTransform: "uppercase" },
  ...
  navActive: { background: "var(--legacy-color-1e293b)", color: "var(--legacy-color-fff)" },
