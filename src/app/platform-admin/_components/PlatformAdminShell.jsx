...
const styles = {
  ...
  brand: { display: "flex", alignItems: "center", gap: "var(--space-3)", marginBottom: "var(--space-5)" },
  kicker: { fontSize: "var(--font-size-xs)", color: "var(--color-text-subtle)", fontWeight: 800, textTransform: "uppercase" },
  ...
  navActive: { background: "var(--legacy-color-1e293b)", color: "var(--color-white)" },
  ...
  subtitle: { margin: 0, color: "var(--legacy-color-475569)", fontWeight: 700 },
  actions: { display: "flex", gap: "var(--space-2)", alignItems: "center", flexWrap: "wrap", justifyContent: "flex-end" },
  badge: {
    display: "inline-flex",
    alignItems: "center",
    gap: 6,
  ...
  primaryButton: {
    ...
    borderRadius: "var(--radius-md)",
    background: "var(--legacy-color-ef4444)",
    color: "var(--color-white)",
    fontWeight: 900,
    cursor: "pointer",
  },
