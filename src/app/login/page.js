...
//  Styles unchanged
const styles = {
  page: { display: "flex", height: "100vh", backgroundColor: "var(--legacy-color-0d0d0d)", fontFamily: "Arial, sans-serif" },
  formSide: { flex: 0.7, backgroundColor: "var(--legacy-color-0d0d0d)", color: "var(--legacy-color-fff)", display: "flex", justifyContent: "center", alignItems: "center", padding: "0 2rem" },
  ...
  subtitle: { fontSize: "14px", color: "var(--legacy-color-9ca3af)", marginBottom: "30px" },
  label: { fontSize: "14px", fontWeight: "500", marginBottom: "6px", display: "block" },
  input: { width: "100%", padding: "12px", marginBottom: "16px", border: "1px solid var(--legacy-color-333)", borderRadius: "6px", fontSize: "15px", backgroundColor: "var(--legacy-color-111827)", color: "var(--legacy-color-fff)" },
  ...
  link: { color: "var(--legacy-color-f87171)", textDecoration: "none", cursor: "pointer" },
  primaryButton: { width: "100%", padding: "12px", backgroundColor: "var(--legacy-color-ef4444)", color: "var(--legacy-color-fff)", border: "none", borderRadius: "6px", fontSize: "16px", fontWeight: "bold", cursor: "pointer", marginBottom: "12px", transition: "background 0.3s" },
  secondaryButton: { width: "100%", padding: "12px", backgroundColor: "var(--legacy-color-111827)", color: "var(--legacy-color-fff)", border: "1px solid var(--legacy-color-374151)", borderRadius: "6px", fontSize: "15px", fontWeight: "bold", cursor: "pointer", marginBottom: "12px" },
  error: { color: "var(--legacy-color-f87171)", marginTop: "15px", fontSize: "14px" },
  success: { color: "var(--legacy-color-86efac)", marginTop: "15px", fontSize: "14px" },
  imageSide: { flex: 1.3, backgroundColor: "var(--legacy-color-1a1a1a)", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", position: "relative" },
