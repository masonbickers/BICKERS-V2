    ...
    <HeaderSidebarLayout>
      <div
        style={{
          ...
          margin: "0 auto",
          padding: "40px 20px",
          backgroundColor: "var(--legacy-color-1c1c1e)",
          color: "var(--legacy-color-e5e5e5)",
          borderRadius: "12px",
          boxShadow: "0 0 0 1px var(--legacy-color-333)",
        }}
      >
        <h1 style={{ fontSize: "28px", fontWeight: "bold", marginBottom: "20px", color: "var(--legacy-color-fff)" }}>
          Terms & Policies
        </h1>

        <section style={{ marginBottom: "30px" }}>
          <h2 style={{ fontSize: "18px", fontWeight: "bold", marginBottom: "10px", color: "var(--legacy-color-f5f5f5)" }}>
            1. Overview
          </h2>
          <p style={{ fontSize: "14px", lineHeight: "1.7", color: "var(--legacy-color-ccc)" }}>
        ...
        <p style={{ fontSize: "13px", marginTop: "40px", color: "var(--legacy-color-888)" }}>
