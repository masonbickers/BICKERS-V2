...
import { Button, EmptyState, Page, PageHeader, Panel } from "@/app/components/ui";
import {
  CalculationDetails,
  CompactRankingTable,
  DrilldownModal,
...
export default function StatisticsPage() {
  ...
  return (
    <HeaderSidebarLayout>
      <Page width="fluid" className={styles.page} innerClassName={styles.inner}>
          <PageHeader
            title="Statistics"
            ...
            actions={
              <div className={styles.headerActions}>
                <Button variant="secondary" onClick={exportAnalyticsSummary} disabled={loading || !jobsFiltered.length} leadingIcon={<Download size={15} />}>
          ...
          {accessGate.checking || loading ? (
            ...
            <EmptyState title="Statistics are unavailable" description="Your account does not currently have access to booking statistics." />
          ) : !jobsFiltered.length ? (
            <EmptyState
            ...
            <>
              {activeTab === "overview" ? (
                <section {...tabPanelProps("overview")}>
                  ...
                  <div className={styles.twoColumn}>
                    <StackedBarChart title="Jobs by month" subtitle="Each booking is counted once using its first booking date" data={bookingsByMonth} rightLabel="Jobs" />
                  ...
                  <Panel className={styles.panelPadding}>
                    <div className={styles.tabHeader}>
                      <div><h3 className={styles.panelTitle}>Next up</h3><p className={styles.panelMeta}>The next eight jobs in this filtered range</p></div>
              ...
              {activeTab === "resources" ? (
                <section {...tabPanelProps("resources")}>
                  ...
                  <div className={styles.twoColumn}>
                    ...
                    <AnalyticsSummarySection title="Crew overview" items={[
              ...
              {activeTab === "finance" ? (
                <section {...tabPanelProps("finance")}>
                  ...
                  <div className={styles.twoColumn}>
                    <AnalyticsSummarySection title="Finance readiness" items={[
                    ...
                    <AnalyticsSummarySection title="Hotel costs" items={[
                  ...
                  <div className={styles.twoColumn}>
                    <AnalyticsSummarySection title="Data quality" items={dataQualityCards.map((item) => ({ label: item.label, value: analytics.dataQuality[item.key], severity: item.severity, onClick: () => drilldownByPredicate(item.title, item.match) }))} />
                    <BarChart title="Payable hotel cost by month" subtitle="Production-paid accommodation is excluded" data={hotelStats.costSeries} rightLabel="GBP" valueFormatter={gbp} />
                  </div>
