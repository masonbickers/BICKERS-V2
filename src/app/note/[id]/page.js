        ...
        <div className={layoutStyles.extracted6}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className={layoutStyles.extracted14}>
              <label className={layoutStyles.extracted15}>Note Text</label>
              <textarea
                value={noteText}
            ...
            <button type="submit" className={layoutStyles.extracted17}>Update Note</button>
            <button type="button" onClick={handleCancel} className={layoutStyles.extracted18}>Cancel</button>
