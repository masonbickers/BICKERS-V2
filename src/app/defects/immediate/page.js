...
const maintenanceBadge = (m) => {
  ...
  if (m === "resolved") return pill("var(--color-success-soft)", "var(--legacy-color-065f46)", "var(--color-success-border)");
                    ...
                    return (
                      <tr key={key} style={{ background: idx % 2 ? "var(--color-white)" : "var(--legacy-color-fcfdff)" }}>
                        ...
                        <td style={{ ...thtd, textAlign: "right", whiteSpace: "nowrap" }}>
                          ...
                          <button
                            type="button"
                            style={{ ...btn("ghost"), padding: "5px 8px", borderRadius: "var(--radius-pill)" }}
