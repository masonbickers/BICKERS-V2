...
const mainContainerStyle = { display: "flex", flexDirection: "column", alignItems: "center", backgroundColor: "var(--legacy-color-1e1e1e)", color: "var(--color-white)", minHeight: "100vh", padding: "40px" };
...
const backButtonStyle = { backgroundColor: "var(--legacy-color-f44336)", color: "var(--color-white)", border: "none", padding: "8px 16px", fontSize: "14px", cursor: "pointer", borderRadius: "6px" };
...
const checkRowStyle = { display: "inline-flex", alignItems: "center", gap: "var(--space-2)", marginBottom: 15, color: "var(--color-white)", fontSize: "var(--font-size-md)", fontWeight: 700 };
const inputStyle = { width: "100%", padding: "12px", marginBottom: "10px", borderRadius: "6px", border: "1px solid var(--legacy-color-444)", fontSize: "14px", backgroundColor: "var(--legacy-color-333)", color: "var(--color-white)" };
const buttonStyle = { width: "100%", padding: "12px", backgroundColor: "var(--legacy-color-1976d2)", color: "var(--color-white)", border: "none", borderRadius: "6px", fontSize: "16px", fontWeight: "bold", cursor: "pointer", marginTop: "20px" };
const cancelButtonStyle = { width: "100%", padding: "12px", backgroundColor: "var(--legacy-color-f44336)", color: "var(--color-white)", border: "none", borderRadius: "6px", fontSize: "16px", fontWeight: "bold", cursor: "pointer", marginTop: "10px" };
