                    ...
                    return (
                      <tr key={key}>
                        ...
                        <td className={layoutStyles.extracted15}>
                          {!m && <span style={semanticBadge("Unsafe defect")}>Urgent</span>}
                          {m === "in_progress" && <span style={semanticBadge("In progress")}>In progress</span>}
...
function NotesModal({ notesModal, onClose, onSave, setNotesModal }) {
  return (
    <Modal
      ...
      title={notesModal.newStatus === "in_progress" ? "Mark as in progress" : "Mark as resolved"}
      size="sm"
      density="compact"
